...
use wgpu::{
    ...
    BindGroupDescriptor, BindGroupEntry, BufferAsyncError, BufferBindingType, MaintainResult,
    RenderPipelineDescriptor as RawRenderPipelineDescriptor, TextureDescriptor,
};
